<div class="container">
  <form method="post" enctype="multipart/form-data" >
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="full_name" placeholder="Adı" value="<?=$post->full_name?>">
      </div>
    </div>
    <div class="form-group row">
      <label class="col-sm-2 col-form-label"><b>Detayını Giriniz.</b><br></label>
      <div class="col-sm-10">
        <textarea name="detail" cols="96%" rows="10" placeholder="Bilgileri"><?=$post->detail?></textarea>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-sm-2 col-form-label"><b>Fiyatını Giriniz.</b><br></label>
      <div class="col-sm-10">
        <input type="number" class="form-control" name="fiyat" placeholder="Fiyatı" value="<?=$post->fiyat?>">
      </div>
    </div>    
